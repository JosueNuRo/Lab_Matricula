...
public class MantenimientoCarrera extends javax.swing.JFrame {
    ...
    private void btn_borrarCarreraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_borrarCarreraActionPerformed
        ...
        if(filaSelec >= 0){
            if(control.eliminarCarrera((String) tbl_carrera.getValueAt(seleccion,0)) == false){
                JOptionPane.showMessageDialog(null, "Carrera eliminada correctamente");
            }else{
                JOptionPane.showMessageDialog(null, "Error al eliminar carrera","",JOptionPane.ERROR_MESSAGE);
            }
            ...
            try {
                ...
                Logger.getLogger(MantenimientoCarrera.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void txt_buscar_carreraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_buscar_carreraActionPerformed
        try {
            ...
            JOptionPane.showMessageDialog(null, "No se encontró la carrera","",JOptionPane.ERROR_MESSAGE);
            btn_listarCarreraActionPerformed(evt);
            Logger.getLogger(MantenimientoCarrera.class.getName()).log(Level.SEVERE, null, ex);
        } catch (NoDataException ex) {
            JOptionPane.showMessageDialog(null, "No se encontró la carrera","",JOptionPane.ERROR_MESSAGE);
